...
This is a Ruby FFI wrapper for the Zint barcode generation library (http://www.zint.org.uk/zintSite). You must have Zint installed on your system for this gem to work at all. 
...
Summary 
  ...
  bc.outfile = "my_bc.png"
  bc.print! # file is now on relative path "my_bc.png"
  bc.outfile = "my_bc.svg"
  bc.print! # file is now on relative path "my_bc.svg"
  
  # create a qrcode
  qrcode = Zint::Barcode.new("test", Zint::BARCODE_QRCODE, :outfile => "qr.png")
  qrcode.print! # file is now on relative path "my_bc.svg"
